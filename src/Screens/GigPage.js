      ...
      {loading ? (
        ...
        <div className="GigPage">
          ...
          <div className="mapContainer">
            <img
              src={
                `https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+555555(${data.coords[0]},${data.coords[1]})/${data.coords[0]},${data.coords[1]},13.08,0/1280x1280?access_token=` +
